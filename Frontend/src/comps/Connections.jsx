  ...
  return (
    <>
      ...
      {userConnections.length === 0 ? (
        <p className="min-h-20 flex items-center justify-center text-2xl text-center">
          No connections yet. Start adding nerds 🤓
        </p>
      ) : (
        <h1 className="text-3xl text-pink-500 text-center my-7">
          See all your connections at one place !
        </h1>
      )}
